...
const AdminDrawerNavigator: React.FC = () => {
  return (
    <Drawer.Navigator drawerContent={(props) => <AdminCustomDrawerContent {...props} />}>
      ...
      <Drawer.Screen name="Content Management" component={AdminContentManagementScreen} />
      <Drawer.Screen name="Property Management" component={AdminPropertyManagementScreen} />
      <Drawer.Screen name="Payment Management" component={AdminPaymentManagementScreen} />
      <Drawer.Screen name="Reporting & Analytics" component={AdminReportingScreen} />
    </Drawer.Navigator>
  );
};
